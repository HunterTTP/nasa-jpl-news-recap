...
function createRoverMarker(latitude, longitude, roverName) {
    ...
    const roverMarkerGeometry = new THREE.SphereGeometry(0.01, 16, 16);
    const roverMarkerMaterial = new THREE.MeshBasicMaterial({ color: 0xFF0000 });
    ...
    roverMarker.position.multiplyScalar(0.991);
